...
export default function CompletedPage(): JSX.Element {
  return (
    <section
      className="bg-[url('../public/img/startup-clue-background.svg')] flex flex-col items-center 
    px-7 min-h-screen relative"
    >
      ...
      <p className="text-body-3 font-helvetica text-center text-white mt-6">
