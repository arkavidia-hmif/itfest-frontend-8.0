...
const Home: React.FC<HomeProps> = ({ dummyProp }) => {
  useEffect(() => {
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-2">
                      ...
                      <p className="font-helvetica font-normal text-xs">
                        Selamat datang di IT Fest! <br/> Sebelum memulai eksplorasi, yuk lihat tutorial <br/> tentang eksplorasi IT Fest di Arkavidia!
                      </p>
                    </div>
                  </div>
                </div>
