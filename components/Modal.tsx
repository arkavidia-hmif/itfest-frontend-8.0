  ...
  return (
    <>
      {status === 'success' && icon === 'green-diamond' && (
        <div
          className={'bg-white relative w-[70%] h-[349px] rounded rounded-b-xl flex flex-col gap-[20px]  items-center justify-center pb-4'}>
          <div>
            <Image
              src={RedCross}
              alt='Red Cross'
          ...
          >
            {scope === 'submit-profile' && (<div className='text-[24px] text-center'>{point} Poin Didapatkan!</div>
            )}
            {scope === 'submit-clue' && (<div className='text-[24px] text-center'>{point} Poin Berhasil Diklaim!</div>)}
            {scope === 'grant-points' && (
              <div className='text-[24px] text-center'>{point} Poin Berhasil Diberikan!</div>)}

            {scope === 'submit-profile' && (<div className='text-[12px] text-center'>
              Selamat! profilmu telah berhasil diperbarui
            </div>)}
            {scope === 'submit-clue' && (<div className='text-[12px] text-center'>
              Selamat! kamu berhasil menebak clue, silakan lanjutkan perjalananmu
            </div>)}
            {scope === 'grant-points' && (<div className='text-[12px] text-center'>
      ...
      {status === 'fail' && icon === 'sad-face' && (
        <div
          className='bg-white relative w-[70%] h-[349px] rounded rounded-b-xl flex flex-col gap-[20px] items-center justify-center '>
          <div>
            <Image
              src={RedCross}
              alt='Red Cross'
          ...
          >
            {scope === 'submit-profile' && <div className='text-[24px] text-center'>Yah, Gagal Submit</div>}
            {scope === 'submit-profile' && <div className='text-[12px] text-center'>Silahkan coba lagi</div>}

            {scope === 'submit-clue' && <div className='text-[24px] text-center'>Yah, Jawabanmu Kurang Tepat</div>}
            {scope === 'submit-clue' && <div className='text-[12px] text-center'>Silahkan coba lagi</div>}

            {scope === 'grant-points' && <div className='text-[24px] text-center'>Yah, Poin Gagal Dikirim</div>}
            {scope === 'grant-points' && <div className='text-[12px] text-center'>Silahkan coba lagi</div>}

            {scope === 'redeem-points' && <div className='text-[24px] text-center'>Yah, Poin Gagal Diklaim</div>}
            {scope === 'redeem-points' && <div className='text-[12px] text-center'>Silahkan coba lagi</div>}
      ...
      {status === 'warning' && icon === 'yellow-warning' && (
        <div
          className='bg-white relative w-[70%] h-[476px] rounded rounded-b-xl flex flex-col gap-[20px] items-center justify-center '>
          <div>
            <Image
              src={RedCross}
              alt='Red Cross'
          ...
          >
            {scope === 'grant-points' && (<div className='text-[24px] text-center mx-4'>
            ...
            {scope === 'redeem-points' && (<div className='text-[24px] text-center mx-4'>
              Merchandise Akan Ditukar Dengan {point} Poin
            </div>)}
            {scope === 'redeem-points' && (<div className='text-[12px] text-center'>
      ...
      {status === 'success' && icon === 'green-bag' && scope === 'add-merchant' && (
        <div
          className={'bg-white relative w-[70%] h-[349px] rounded rounded-b-xl flex flex-col gap-[20px]  items-center justify-center pb-4'}>
          <div>
            <Image
